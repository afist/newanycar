...
<body style="background-size: 100% 100%;">
	<div id="senks_block">
		...
		<h1><? if(isset($name)){echo $name;} ?><br>Благодарим за интерес, проявленный к сервису NewAnyCar</h1>
		<p class='senks_text'>Мы перезвоним вам в ближайшее время,.<br><br>Пожалуйста, проконтролируйте чтобы ваш контактный телефон <b>"<?=$tel?>"</b> был включен.</p>
	</div>
